...
class SlotRow(Frame):
    ...
    def __init__(self, master, index, slot, width, height, *args, **kwargs):
        ...
        self.itemLabel = Label(self, text=slot.item.item_id, bg="white", relief="groove")
        self.itemLabel.place(x=(9 / 37) * width, y=0, width=(7 / 37) * width, height=height)
        self.hitsLabel = Label(self, text=slot.item.hits, bg="white", relief="groove")
        self.hitsLabel.place(x=(16 / 37) * width, y=0, width=(5 / 37) * width, height=height)
        self.dayshitsLabel = Label(self, text=slot.item.dayshit, bg="white", relief="groove")
        self.dayshitsLabel.place(x=(21 / 37) * width, y=0, width=(6 / 37) * width, height=height)
        self.avgLabel = Label(self, text=slot.item.avehitsday, bg="white", relief="groove")
